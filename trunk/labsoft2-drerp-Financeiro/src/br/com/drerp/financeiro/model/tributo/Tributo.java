...
public class Tributo extends GenericModel {
	...
	@OneToMany(mappedBy = "tributo")
	private List<ContribuicaoMelhoria> contribuicoesMelhorias;
	...
	public List<ContribuicaoMelhoria> getContribuicoesMelhorias() {
		return contribuicoesMelhorias;
	}

	public void setContribuicoesMelhorias(
			List<ContribuicaoMelhoria> contribuicoesMelhorias) {
		this.contribuicoesMelhorias = contribuicoesMelhorias;
	}
