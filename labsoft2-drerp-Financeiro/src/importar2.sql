...
--SALARIO
INSERT INTO `financeiro-db`.`fin_salario` (`id`, `dataLimiteMilis`, `dataRequisicaoMilis`, `status`, `valor`, `cargo`, `departamento`, `horasTrabalhadas`) VALUES (1, 485967348, 1323741600000, 0, 2452, 'Estgiario', 0, 123);
INSERT INTO `financeiro-db`.`fin_salario` (`id`, `dataRealizacaoMilis`, `dataRequisicaoMilis`, `status`,`valor`, `cargo`, `departamento`, `horasTrabalhadas`) VALUES (2, 1327111200000, 1327111200000, 1, 222.22, 'Zelador', 1, 33);
INSERT INTO `financeiro-db`.`fin_salario` (`id`, `dataLimiteMilis`, `dataRealizacaoMilis`, `status`, `valor`, `cargo`, `departamento`, `horasTrabalhadas`) VALUES (3, 485967348, 1323741600000, 1, 444, 'Estgiario', 0, 44);
--TRANSFERENCIA
...
--CONTARECEBER
INSERT INTO `financeiro-db`.`fin_contareceber` (`id`, `dataRealizacaoMilis`, `status`, `valor`) VALUES (1, 1323741600000, 1, 333.33);
INSERT INTO `financeiro-db`.`fin_contareceber` (`id`, `dataRealizacaoMilis`, `status`, `valor`) VALUES (2, 1327111200000, 1, 222.22);

--FATURA
INSERT INTO `financeiro-db`.`fin_fatura` (`id`, `planoSaude_id`, `contaReceber_id`) VALUES (1, 1, 1);
INSERT INTO `financeiro-db`.`fin_fatura` (`id`, `planoSaude_id`, `contaReceber_id`) VALUES (2, 1, 1);
INSERT INTO `financeiro-db`.`fin_fatura` (`id`, `planoSaude_id`, `contaReceber_id`) VALUES (3, 2, 2);
INSERT INTO `financeiro-db`.`fin_fatura` (`id`, `planoSaude_id`, `contaReceber_id`) VALUES (4, 2, 2);